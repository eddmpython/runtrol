...
이 판의 유일한 사업모델 사망 사례 (vibe-kanban: "신날 만한 수익 모델을 못 찾았다") 에 대한 runtrol 의 답은 수익이 아니라 **기여**다. MIT 에 호스팅도 계정도 없으므로 팔 것이 애초에 없고, 지속가능성은 기여자 에너지에서 온다. 그리고 기여자는 광고가 아니라 품질에 온다.

...
| [sessionDialogue.md](sessionDialogue.md) | process-scoped opaque courier, isolated-worker spawn, result review, resume and cleanup, bounded calls, and no-residue verification |

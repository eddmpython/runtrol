// Contract test for the next landing. Mirrors site/test.mjs so promotion into site/ keeps the same
// guarantees, and adds the two things this page introduces: the two-tone mark and the sidebar scene.
...
console.log("Landing contract tests passed, including eight red-path mutations.");

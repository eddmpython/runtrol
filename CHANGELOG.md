...
- On Windows, the working indicator resets after interrupted conversations reopen and recognizes turns started
  by the current process. It stays active through silent tool calls until the turn ends or is interrupted.

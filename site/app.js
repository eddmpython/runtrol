...
const COPY = {
  en: {
    ...
    phoneProgress: "Secure phone app in progress",
    phoneHonesty: "The install action will appear only after pairing and transport gates pass.",
  ...
  ko: {
    ...
    phoneProgress: "안전한 휴대폰 앱 구현 중",
    phoneHonesty: "페어링과 전송 게이트를 통과한 뒤에만 설치 동작을 제공합니다.",
  ...
  zh: {
    ...
    phoneProgress: "安全手机应用开发中",
    phoneHonesty: "只有配对和传输门槛通过后才会提供安装操作。",
  ...
  ja: {
    ...
    phoneProgress: "安全なスマートフォンアプリを開発中",
    phoneHonesty: "ペアリングと通信ゲートを通過した後にのみインストール操作を提供します。",

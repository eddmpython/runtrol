...
const COPY = {
  en: {
    ...
    primaryInstallState: "Runtrol Studio is publicly available for supported native platforms and updates through VS Code.",
  ...
  ko: {
    ...
    primaryInstallState: "지원되는 네이티브 플랫폼용 Runtrol Studio가 공개되어 있으며 VS Code가 자동 갱신합니다.",
  ...
  zh: {
    ...
    releaseFound: "GitHub Releases 已提供手动安装用 VSIX。自动更新需要从 Marketplace 安装。",
    sessions: "会话",
    ...
    primaryInstallState: "Runtrol Studio 已面向支持的原生平台公开发布，并由 VS Code 自动更新。",
  ...
  ja: {
    ...
    releaseFound: "手動インストール用 VSIX を GitHub Releases から取得できます。自動更新には Marketplace からのインストールが必要です。",
    sessions: "セッション",
    ...
    primaryInstallState: "対応するネイティブプラットフォーム向け Runtrol Studio を公開しており、VS Code が自動更新します。",

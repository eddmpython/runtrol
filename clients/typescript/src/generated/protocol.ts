...
export interface TerminalDescriptor { readonly controlGeneration?: number; readonly controlHeld?: boolean; readonly dialogueEnabled?: boolean; readonly geometry: TerminalGeometry; readonly memoryBytes?: number | null; readonly nativeSessionId?: string | null; readonly openedAtMs: number; readonly origin?: TerminalOrigin; readonly ownerTerminalKey?: string | null; readonly ownerWindowSessionId?: string | null; readonly processState: TerminalProcessState; readonly providerId: ProviderId; readonly runtimeGeneration: string; readonly terminalGeneration: number; readonly terminalId: RuntimeTerminalId; readonly viewerCount?: number; readonly workspace: string; }

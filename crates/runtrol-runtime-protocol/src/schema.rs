...
use crate::{
    ...
    ProvidersNativeActivityChangedNotification, ProvidersUsageChangedNotification,
    ...
    RuntimeModelCatalog, RuntimeProviderCapabilities, RuntimeTerminalId, RuntimeTerminalViewId,
    ...
    StartSessionParams, SubmitBlocksParams, SubmitInputParams, TerminalAcquireControlParams,
    TerminalAttachParams, TerminalControlLease, TerminalControlParams, TerminalDescriptor,
    TerminalDetachParams, TerminalExitedNotification, TerminalIndexChangedNotification,
    TerminalIndexEndedNotification, TerminalIndexSnapshot, TerminalLaggedNotification,
    TerminalOpenParams, TerminalOutputNotification, TerminalResizeParams,
...
struct PublicProtocolSchema {
    ...
    providers_native_activity_changed: ProvidersNativeActivityChangedNotification,
    ...
    terminal_set_dialogue: TerminalSetDialogueParams,
    ...
    window_mirror_open: WindowMirrorOpenParams,

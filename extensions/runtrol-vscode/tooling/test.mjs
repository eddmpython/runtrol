...
await build({
  entryPoints: {
    ...
    "nativeChatCatalogue.test": path.join(extensionRoot, "src/nativeChatCatalogue.test.ts"),
    "pairingQr.test": path.join(extensionRoot, "src/pairingQr.test.ts"),
    "presentation.test": path.join(extensionRoot, "src/webview/presentation.test.ts"),
    "telemetry.test": path.join(extensionRoot, "src/webview/telemetry.test.ts"),
    "sessionConfiguration.test": path.join(extensionRoot, "src/sessionConfiguration.test.ts"),
    ...
    "webviewReady.test": path.join(extensionRoot, "src/webviewReady.test.ts"),
...
const result = spawnSync(process.execPath, [
  ...
  path.join(out, "nativeChatCatalogue.test.js"),
  path.join(out, "pairingQr.test.js"),
  path.join(out, "presentation.test.js"),
  path.join(out, "telemetry.test.js"),
  path.join(out, "sessionConfiguration.test.js"),
  ...
  path.join(out, "webviewReady.test.js"),
